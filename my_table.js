            ...
            return function postlink ($scope, iElement, iAttrs, controller) {
                ...
                */
                var getData = function() {
                    ...
                    if (filterText) {
                        return $filter('filter')($scope.rows, filterText);
                    }
                ...
                */
                ...
                $scope.$watch('rows.length', function (newValue) {
                    $scope.tableParams.reload();
                });
                ...
                */
                ...
                var $thead = $('<thead/>').html(headerTemplate);
    ...
    return {
        ...
        link: function ($scope, iElement, iAttrs, controller) {
            ...
            $scope.$watch('col.format', function (newVal) {
                if (newVal) {
                    iElement.html(newVal($scope.row[$scope.col.field], $scope.row));
            ...
            $scope.$watch('col.click', function (newVal) {
                if (newVal) {
                    ...
                    iElement.click(function (e) {
                        newVal(e, $scope.row[$scope.col.field], $scope.row);
                    });
                }
            });
        }
...
myTableApp.run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put('ng-table/pager.html',
        template.replace('ng-class="{\'disabled\': !page.active}"',
                         'ng-class="{\'disabled\': !page.active, active: (page.number===params.page()) && (page.type===\'page\' || page.type===\'first\' || page.type===\'last\')}"'));
}]);
