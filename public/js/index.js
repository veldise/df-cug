var dnfCugApp = angular.module('dnfCugApp', [
	'ngRoute', 'ngCookies',
	'ui.bootstrap', 'myTable'
]);

dnfCugApp.config(['$logProvider', function ($logProvider) {
    // disable debug level messages
    $logProvider.debugEnabled(false);
}]);

dnfCugApp.controller('NavbarCtrl', ['$scope', '$http', function ($scope, $http) {
...
dnfCugApp.controller('MemberListCtrl', ['$scope', '$http', '$location', '$cookies', function ($scope, $http, $location, $cookies) {
	$scope.sep = '/';
	$scope.postno = $location.search().postno || $cookies.postno || 47186;
